...
module.exports={
    SendEmail:(to,subject,body)=>{
        ...
        let mailDetails = {
            ...
            subject: 'New customer message received', // כותרת המייל 
            // נצרף תוכן למייל בפורמט HTML
            html:`                                  
            <p>Hello,</p>
            <p>We have received a new message from a customer with the following details:</p>
            <p>Customer Name: ${body.firstName}  ${body.lastName}<br>
            Customer Email: ${body.Email}<br>
            Message Title: ${body.title}</p>
            <p>Message:</p>
            <p>${body.messageBody}</p>
            <p>Please review this message and take the appropriate action.</p>
            <p>Best regards,</p>
            <p>HotZone</p>
